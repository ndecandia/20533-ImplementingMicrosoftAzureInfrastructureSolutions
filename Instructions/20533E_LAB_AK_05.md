...
23. Press **Publish** button and it will automatically build and publish the web app from Visual Studio to the Azure Web app you created in this task and open a new tab in the Microsoft Edge window displaying it.
